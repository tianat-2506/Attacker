...
export default function App() {
  ...
  const recoveryBuyerId = useMemo(() => recoveryBuyerIdForAccount(activeAccount, shock.affectedNodeIds), [activeAccount, shock.affectedNodeIds]);
  ...
  useEffect(() => {
    ...
    getRecommendations(recoveryBuyerId, selectedPeriod, disruptedSupplierId)
      .then((shortlist) => {
