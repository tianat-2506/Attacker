    ...
    <main className="app-shell">
      ...
      <section className={boundaryBanner ? "main-shell has-boundary-banner" : "main-shell"}>
        ...
        <div className="view-content">
          ...
          {activeView === "risk" ? <RiskWorkspace signal={riskSignal} canOpenMatching={allowedViewIds.includes("matching")} onOpenMatching={() => openView("matching")} /> : null}
          {activeView === "matching" ? <MatchingWorkspace recommendations={recommendations} request={connectionRequest} selectedPeriod={selectedPeriod} accessByBusinessId={accessByBusinessId} canConnect={canRequestIntroduction} onConnect={handleConnectionRequest} /> : null}
