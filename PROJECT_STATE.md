...
- Added runtime-config coverage for pilot validation issue serialization and status transitions.
...
- Backend full: `python -B -m unittest discover -s backend\tests` passed, 134 tests, 2 skipped.
...
- Latest targeted backend proof:
  ...
  - `python -B -m unittest discover -s backend\tests` passed, 134 tests, 2 skipped.
